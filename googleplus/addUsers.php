...
var generate = function () {
    ...
    var save_student = function(studentObj) {
      ...
      user.set("schoolID" , schools[document.getElementById("schoolinput").value]);
    ...
    $(window).load(function() {
        ...
        document.getElementById("submit-button").addEventListener("click", function () {
         ...
         document.getElementById("modal-text").innerHTML= "Are you sure you want to add these emails as admins?";
          document.getElementById("OKModal").value="Add Admin";
          ...
          $("#OKModal").click(function() {
            ...
            for (var i = 0; i < num_commas + 1; i++) {
              ...
              if (email_text.indexOf(',') == -1) {
                  promise_array[i] = {email: email_text, code: code};
                } else {
                  ...
                  promise_array[i] = {email: email, code: code};
                }
            }
             modal.style.display = "none";
